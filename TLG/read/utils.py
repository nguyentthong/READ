from read.model import ReadParametrization
from torch import nn


def apply_to_read(fn):
    """apply a function to ReadParametrization layers, designed to be used with model.apply"""
...
def tie_weights(linear: nn.Linear, embedding: nn.Embedding):
    """tie the weights of the linear layer and the embedding layer both with the same read"""
